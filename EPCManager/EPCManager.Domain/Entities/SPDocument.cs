...
{
    public class SPDocument : SPEntity, ILockableEntity, ILifeCycleEntity, ICopiableEntity, IAssociableEntity, IEquatable<SPDocument>, IComparable<SPDocument>
    {
        ...
        public virtual SPPhase Phase { get; set; }
        public virtual SPIdentifier Identifier { get; set; }
        public virtual char Template { get; set; }
        ...
        public virtual SPDocument Clone()
        {
        ...
        public override bool Equals(object obj)
        {
            if (obj != null && GetType() == obj.GetType())
                return Equals(obj as SPDocument);
        ...
        public virtual bool Equals(SPDocument other)
        {
        ...
        /// <returns></returns>
        public virtual int CompareTo(SPDocument other)
        {
